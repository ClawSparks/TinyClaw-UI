# TinyClaw Control Center Install Prompt

Language: [中文](INSTALL_PROMPT.md) | **English**

Give the full prompt below to your own OpenClaw so it can install and connect `TinyClaw Control Center` to this machine's OpenClaw environment.

```text
You are installing and connecting TinyClaw Control Center to this machine's OpenClaw environment.
