# TinyClaw Control Center

<img src="docs/assets/overview-hero-en.png" alt="TinyClaw Control Center overview hero screenshot" width="1200" />

TinyClaw (built on the OpenClaw ecosystem): safety-first local control center.
...
- [INSTALL_PROMPT.en.md](docs/setup/INSTALL_PROMPT.en.md)
- [INSTALL_PROMPT.md](docs/setup/INSTALL_PROMPT.md)
...
- `docs/RUNBOOK.md`
- `docs/setup/INSTALL_PROMPT.en.md`
- `docs/setup/INSTALL_PROMPT.md`
- `docs/PROGRESS.md`
- `scripts/README.md`
